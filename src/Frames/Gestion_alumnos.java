...
public class Gestion_alumnos extends javax.swing.JFrame {
    ...
    public Gestion_alumnos() {
        ...
        try {
            ...
            tablaGestionAlumnos = new JTable(modelo);
            
            tablaGestionAlumnos.getTableHeader().setFont(new Font("Roboto", Font.BOLD, 12));
            tablaGestionAlumnos.getTableHeader().setOpaque(false);
            tablaGestionAlumnos.getTableHeader().setBackground(Color.WHITE);
            tablaGestionAlumnos.getTableHeader().setForeground(Color.BLACK);
            tablaGestionAlumnos.setRowHeight(25);
            tablaGestionAlumnos.getTableHeader().setReorderingAllowed(false);
            ...
            tablaGestionAlumnos.getColumnModel().getColumn(3).setCellRenderer(centerAlight);
            tablaGestionAlumnos.getColumnModel().getColumn(4).setCellRenderer(centerAlight);
            cn.close();
        } catch (SQLException e) {
            System.err.println("Error en el llenado de la tabla alumnos");
        }
        
        tablaGestionAlumnos.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseClicked(MouseEvent e){
                int filaPoint = tablaGestionAlumnos.rowAtPoint(e.getPoint());
                int columnaPoint = 0;
    ...
    private void initComponents() {
        ...
        title.setText("GESTIÓN DE ALUMNOS");
        ...
        bg.add(volverBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 430, -1, -1));

        tablaGestionAlumnos.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        ...
        tablaGestionAlumnos.setGridColor(new java.awt.Color(204, 204, 204));
        tablaGestionAlumnos.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tablaGestionAlumnos);
